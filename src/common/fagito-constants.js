...
export const FAGITO_SIGNUP_SIGNIN_BROWSE_BUTTONS_SCREEN = 'fagito.signup-signin-browse-buttons-screen';
export const FAGITO_SIGNUP_SCREEN = 'fagito.signup-screen';
